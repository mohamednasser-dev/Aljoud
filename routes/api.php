...
//student
    ...
    Route::get('/student/buy/{type}/payment_step_two/{payment_method}/{course_id}', [HomeCoursesController::class, 'payment_step_two']);
...
//cpanel users
        ...
        Route::get('/users/{type}/export/pdf', [UsersController::class, 'export_pdf']);
//instructors
